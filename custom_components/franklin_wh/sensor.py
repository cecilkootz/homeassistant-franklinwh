...
SENSOR_TYPES: tuple[FranklinWHSensorEntityDescription, ...] = (
    ...
    FranklinWHSensorEntityDescription(
        ...
        last_reset_fn=_local_day_start,
        value_fn=lambda data: (
            # Use direct telemetry for grid-to-battery energy.
            data.stats.totals.grid_to_battery
    ...
    FranklinWHSensorEntityDescription(
        ...
        value_fn=lambda data: (
            data.stats.totals.switch_1_use / 1000) if data.stats else None,
    ),
    FranklinWHSensorEntityDescription(
        key="switch_2_load",
        name="Switch 2 Load",
    ...
    FranklinWHSensorEntityDescription(
        ...
        state_class=SensorStateClass.TOTAL_INCREASING,
        value_fn=lambda data: (
            data.stats.totals.switch_2_use / 1000) if data.stats else None,
    ),
    FranklinWHSensorEntityDescription(
        key="v2l_use",
        name="V2L Use",
    ...
    FranklinWHSensorEntityDescription(
        ...
        state_class=SensorStateClass.TOTAL_INCREASING,
        value_fn=lambda data: (
            data.stats.totals.v2l_export / 1000) if data.stats else None,
    ),
    FranklinWHSensorEntityDescription(
        key="v2l_import",
        name="V2L Import",
        ...
        state_class=SensorStateClass.TOTAL_INCREASING,
        value_fn=lambda data: (
            data.stats.totals.v2l_import / 1000) if data.stats else None,
    ),
    FranklinWHSensorEntityDescription(
    ...
    FranklinWHSensorEntityDescription(
        ...
        value_fn=lambda data: (
            _format_backup_time(
                data.charge_power_details.estimated_backup_minutes)
